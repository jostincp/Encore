...
export const config: Config = {
  ...
  PORT: parseNumber(process.env.MENU_SERVICE_PORT || process.env.PORT, 3005),
  ...
  POINTS_SERVICE_URL: process.env.POINTS_SERVICE_URL || 'http://localhost:3006',
  ANALYTICS_SERVICE_URL: process.env.ANALYTICS_SERVICE_URL || 'http://localhost:3007',
